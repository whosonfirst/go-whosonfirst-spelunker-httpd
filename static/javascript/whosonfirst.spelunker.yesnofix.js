...
whosonfirst.spelunker.yesnofix = (function(){
	...
	*/
	...
	'render_trigger': function(ctx){
	    ...
	    trigger.onclick = whosonfirst.spelunker.yesnofix.ontrigger;
	    return trigger;
	},
	...
	*/
	...
	'render_input': function(id){
	    ...
	    yes.onclick = whosonfirst.spelunker.yesnofix.onassert;
	    no.onclick = whosonfirst.spelunker.yesnofix.onassert;
	    fix.onclick = whosonfirst.spelunker.yesnofix.onassert;
	    cancel.onclick = whosonfirst.spelunker.yesnofix.oncancel;
	    about.onclick = whosonfirst.spelunker.yesnofix.onabout;
